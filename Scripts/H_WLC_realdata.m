function Dat = H_WLC_realdata(chromosome);
...
Po(1,1) = PolyL(1,1) + GPL(1,1) + Phyp(1,1) - Zan(1,1);
...
mkdir('./HWLC_r')
save(['./HWLC_r/InCorrectPrior_Tunep_Tunehyp_' num2str(chromosome) '_het.mat'],'Dat')
