function Part = EmulatePartition(Arc);
...
Htrue = log(abs(     repmat(exp(Hbase'),100000,1) + [randn(100000,2)*1,zeros(100000,1)]      ));
...
%mkdir('./HWLC_r')
save(['../Results/Partition/EmulatePartition_' num2str(Arc) '.mat'],'-v7.3','Part')
