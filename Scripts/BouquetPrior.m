function [X,Y,Z,Energy_WLC] = BouquetPrior(varargin);
%
%Description
%
...
E_c  = (ll)*0 + ((len) -ll)*U;
Energy_WLC(i,1) = Energy_WLC(i-1,1) + (k/a)*En2 - (k/a)*En1 - PvMF1(i,1) - PvMF2(i,1) + PvMF1(i-1,1) + PvMF2(i-1,1);
...
Energy(i,1) = Energy_WLC(i,1) + E_c + 3*sum(rx.^2 + ry.^2 +rz.^2)/(2*a^2)  - PvMF1(i,1) - PvMF2(i,1) + PvMF1(i-1,1) + PvMF2(i-1,1);
