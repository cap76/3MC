function [net] = BouquetOpt(varargin);
...
path(path,'/Users/christopherpenfold/Documents/MATLAB/qrot3d')
...
if UpdateProgress('Running Analysis...')
    return;
end
...
[Pr] = qrot3d(Xsub,usub/udiv,thet(i,1));

%[A] = qrot3d([1,2,3],[0,0,1],23)
%[Pr] = Quaternion3(23,[0,0,1],[1,2,3])
%__________________________________________________________________________
