function [net] = Rabl(varargin);

%RablPrior - Markov chain Monte Carlo algorithm for simulating chromosome trajectories when telomeres are attached to the nuclear periphery and a priori distributed according to a von Mises-Fisher distribution. 
...
%
% usage: Note this function is the same as for Rabl unless excluded volume
% parameters are used
%
