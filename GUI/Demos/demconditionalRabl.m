...
Cen     = 50;                   %Position of centromere (bead number).
...
[net1 ] = conditionalRabl(Parameters1,x1,y1,z1,VMF);
[net2 ] = conditionalRabl(Parameters1,x1,y1,z1,VMF);

Width   = -0.0056*Phi^2 + 1.6*Phi -3.4; 
Width   = 100;
%Plot example configuration after N steps.
PolymerPic(net1.Parameters,net1.X,net1.Y,net1.Z,Width,No);
