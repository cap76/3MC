function [] = Bouquet_30(Chrom,Comp);
...
[Data   ] = Bouquet(Parameters,x1,y1,z1,VMF);
    
       
    
for i = 1:25

    [Data   ] = Bouquet(Parameters,Data.X(end,:),Data.Y(end,:),Data.Z(end,:),VMF);

    if i>15
        save(['../Bouquet/Bouquet_' num2str(Comp) 'nm_Chrom_' num2str(Chrom) '_' num2str(kk) '_' num2str(j) '_' num2str(i) '.mat'],'Data')
    else    
    end
